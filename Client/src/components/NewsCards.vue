<template>
  <div id="home">
    <b-container fluid>
      <b-row
        style="margin-top: -3.5rem; align-items: center; margin-bottom: 0.3rem"
      >
        ...
        <b-col>
          <button @click="addNews()" class="btn btn-secondary addNews">
            <span v-if="userID === 0"
              >Columnist? Sign up to write articles</span
            >
    ...
    <div v-for="article in news" :key="article.id">
      <b-card
        no-body
        class="overflow-hidden cardSize"
      ...
      >
        ...
        <div class="editdelete">
          <a
            v-if="userID === article.author || userID === 1"
