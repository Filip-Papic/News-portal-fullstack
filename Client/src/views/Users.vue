<template>
    <div id="home">
      <UserTable :users="users" @deleteUser="deleteUser" @changeStatus="changeStatus" />
      <Pagination :perPage="perPage" :news="users.length" :currentPage="currentPage" :pageName="'AllUsers'" :search="''"/>
    </div>
</template>
